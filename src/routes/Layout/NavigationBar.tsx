  ...
  return (
    <div className="flex justify-between bg-white">
      <div className="flex p-2 navBar">
        <Link to="/" className="p-3 text-2xl font-bold bg-white border-white shadow-none">
          mangrove
        </Link>
      </div>

      <div className="flex p-3 navBar">
        <Link
          to="/"
      ...
      <div className="flex items-center p-2">
        {!loggedUser && (
          <RRLink
            to="/login"
            className="text-blue-500 bg-white border-none shadow-none btn btn-sm hover:bg-white">
            로그인
          </RRLink>
        )}
